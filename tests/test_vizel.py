...
def stderr_expected(zettelkasten_directory):
    ...
    python2_unicode_decode_message = (
        "Skipping 202006112225_broken_utf8.{ext}: 'ascii' codec can't decode"
        " byte 0xff in position 0: ordinal not in range(128)\n"
    )
    python3_unicode_decode_message = (
        "Skipping 202006112225_broken_utf8.{ext}: 'utf-8' codec can't decode"
